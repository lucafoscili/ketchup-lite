      ...
      children: [
          ...
          children: [
            {
              children: [
                ...
                },
                {
                  id: DOC_IDS.content,
                  value:
                    ' is responsible for handling language translation and localization for the Ketchup Lite library. It allows developers to manage multiple languages and variants for their components.',
                },
              ],
              ...
              children: [
                {
                  id: DOC_IDS.content,
                  value:
                    'KulLanguage provides tools to easily set and get the current language, handle translation keys, and manage component language changes dynamically.',
                },
              ],
              id: DOC_IDS.paragraph,
              value: '',
        ...
        },
        {
          ...
          children: [
            PARAGRAPH_FACTORY.asBulletListEntry('KulLanguageKey', [
              {
                ...
                description: ': Language key for checkbox-related terms.',
              },
              {
                title: 'KulLanguageColumn',
                description: ': Language key for column-related terms.',
              },
              {
                title: 'KulLanguageDashboard',
                description: ': Language key for dashboard-related terms.',
              },
              {
                title: 'KulLanguageDebug',
                description: ': Language key for debugging-related terms.',
              },
              {
                title: 'KulLanguageGeneric',
                description: ': General language key for miscellaneous terms.',
              },
            ]),
            DOC_NODES.hiddenSeparator,
            PARAGRAPH_FACTORY.asBulletListEntry('KulLanguageValue', [
              {
            ...
            DOC_NODES.hiddenSeparator,
            PARAGRAPH_FACTORY.asBulletListEntry('KulLanguageDefaults', [
              {
                title: 'en',
                description: ': Default language set to English.',
              },
              {
                title: 'it',
                description: ': Default language set to Italian.',
              },
              {
                title: 'fr',
                description: ': Default language set to French.',
              },
              {
                title: 'es',
                description: ': Default language set to Spanish.',
              },
            ]),
          ],
        },
              ...
              [
                {
                  name: 'key',
                  type: 'KulLanguageKey',
                  description: 'The translation key to lookup.',
                },
                {
                  name: 'language?',
                  type: 'string',
              ...
              [
                {
                  name: 'language',
                  type: 'string',
                  description: 'The language string to decode, e.g., en_US.',
                },
              ],
            ),
            DOC_NODES.hiddenSeparator,
