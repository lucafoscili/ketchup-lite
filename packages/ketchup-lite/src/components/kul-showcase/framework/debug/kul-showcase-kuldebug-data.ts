                    ...
                    children: [
                        {
                            children: [
                                ...
                                {
                                    id: DOC_IDS.content,
                                    value: ' is the debugging utility for the Ketchup Lite library. It provides tools to monitor, log, and analyze the component lifecycle and other aspects of the application.',
                                },
                            ],
                        ...
                        },
                        {
                            children: [
                                {
                                    id: DOC_IDS.content,
                                    value: "KulDebug allows developers to track component rendering, handle log messages, and manage debug sessions for improved insight into the system's inner workings.",
                                },
                            ],
                            id: DOC_IDS.paragraph,
                            value: '',
                ...
                },
                {
                    ...
                    children: [
                        PARAGRAPH_FACTORY.asBulletListEntry(
                            'KulDebugLifecycleInfo',
                            [
                                {
                                    title: 'endTime (number)',
                                    description:
                                        ': Timestamp for the end of the lifecycle event.',
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    description:
                                        ': Timestamp when the rendering completed.',
                                },
                                {
                        ...
                        PARAGRAPH_FACTORY.asBulletListEntry('KulDebugLog', [
                            ...
                            },
                            {
                                ...
                                description:
                                    ': Type of the log, e.g., load, render, resize.',
                            },
                        ]),
                        DOC_NODES.hiddenSeparator,
                        PARAGRAPH_FACTORY.asBulletListEntry(
                            ...
                            [
                                {
                                    title: 'informational',
                                    description:
                                        ': Represents informational log messages.',
                                },
                                {
                                    title: 'warning',
                                    description:
                            ...
                            [
                                {
                                    ...
                                    description:
                                        'The component for which the log is created.',
                                },
                                {
                                    name: 'message',
                                    type: 'string',
                            ...
                            [
                                {
                                    ...
                                    description:
                                        'The component to be registered for debugging.',
                                },
                            ]
                        ),
                        DOC_NODES.hiddenSeparator,
                            ...
                            [
                                {
                                    ...
                                    type: 'boolean',
                                    description:
                                        'Optional value to set debug state explicitly.',
                                },
                                {
                                    name: 'dispatch?',
                                    type: 'boolean',
