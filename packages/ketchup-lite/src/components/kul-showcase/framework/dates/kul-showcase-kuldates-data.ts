                    ...
                    children: [
                        {
                            children: [
                                ...
                                {
                                    id: DOC_IDS.content,
                                    value: ' is the date management utility for the Ketchup Lite library. It provides powerful APIs for handling localization, formatting, and normalization of dates, times, and timestamps.',
                                },
                            ],
                        ...
                        },
                        {
                            children: [
                                {
                                    id: DOC_IDS.content,
                                    value: 'KulDates uses the Day.js library for its core date-handling logic and extends it with functionality for managing locales, formatting dates, and more.',
                                },
                            ],
                            id: DOC_IDS.paragraph,
                            value: '',
                        ...
                        PARAGRAPH_FACTORY.asBulletListEntry(
                            ...
                            [
                                ...
                                },
                                {
                                    title: 'TIMESTAMP',
                                    description:
                                        ': Normalizes the input to a Unix timestamp.',
                                },
                            ]
                        ),
                            ...
                            [
                                {
                                    ...
                                    description:
                                        'The locale to set for date formatting.',
                                },
                            ]
                        ),
                        DOC_NODES.hiddenSeparator,
                        ...
                        PARAGRAPH_FACTORY.asListEntry(
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    type: 'string',
                                    description:
                                        'Optional format to validate against.',
                                },
                                {
                                    name: 'strict?',
                                    type: 'boolean',
                                    description:
                                        'If true, strict parsing is applied.',
                                },
                            ]
                        ),
                    ],
