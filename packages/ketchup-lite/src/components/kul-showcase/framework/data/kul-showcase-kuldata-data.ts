          ...
          children: [
            {
              children: [
                ...
                },
                {
                  id: DOC_IDS.content,
                  value:
                    " is the core data management engine for the Ketchup Lite library. It handles data structures such as cells, nodes, and datasets, allowing consistent UI state and efficient data flow.",
                },
              ],
              ...
              children: [
                {
                  id: DOC_IDS.content,
                  value:
                    "KulData is responsible for managing the JSON structures used across different components, including KulDataDataset, KulDataNode, KulDataColumn, and KulDataCell types.",
                },
              ],
              id: DOC_IDS.paragraph,
              value: "",
          ...
          children: [
            ...
            PARAGRAPH_FACTORY.asBulletListEntry("KulDataNode", [
              ...
              },
              {
                ...
                description: ": Contains one or more data cells.",
              },
              {
              ...
              {
                title: "icon (string)",
                description: ": Optional icon for the node representation.",
              },
            ]),
            DOC_NODES.hiddenSeparator,
              ...
              [
                {
                  name: "dataset",
                  type: "KulDataDataset",
                  description: "The dataset containing nodes.",
                },
                {
                  name: "filters",
              ...
              [
                {
                  name: "nodes",
                  type: "KulDataNode[]",
                  description: "The dataset containing the nodes.",
                },
                {
                  name: "child",
                  type: "KulDataNode",
            ...
            PARAGRAPH_FACTORY.asListEntry(
              ...
              [
                ...
                },
                {
                  ...
                  description: "Event dispatcher for handling events.",
                },
              ],
            ),
          ],
                ...
                DOC_NODES.hiddenSeparator,
                {
                  cells: {
                    kulCode: {
                      shape: "code",
                      value:
                        "const filteredNodes = KulData.node.filter(dataset, { value: 'This is a new node' });\nconsole.log(filteredNodes.matchingNodes);",
                    },
                  },
                  id: DOC_IDS.content,
                },
