                    ...
                    children: [
                        {
                            children: [
                                ...
                                {
                                    id: DOC_IDS.content,
                                    value: ' is the central theme manager for the Ketchup Lite library. It controls CSS variables, fonts, and icons for various visual components to ensure a cohesive look and feel across the entire library.',
                                },
                            ],
                        ...
                        },
                        {
                            children: [
                                {
                                    id: DOC_IDS.content,
                                    value: 'With KulTheme, developers can switch themes, manage CSS variables, define custom icons, and adjust other visual aspects dynamically.',
                                },
                            ],
                            id: DOC_IDS.paragraph,
                            value: '',
                        ...
                        PARAGRAPH_FACTORY.asBulletListEntry(
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    description:
                                        ': Defines the height of the header component.',
                                },
                                {
                                    title: '--kul-drawer-width',
                                    description:
                                        ': Defines the width of the drawer component.',
                                },
                            ]
                        ),
                        DOC_NODES.hiddenSeparator,
                        ...
                        PARAGRAPH_FACTORY.asListEntry(
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    type: 'KulThemeJSON',
                                    description:
                                        'Optional custom theme list to use.',
                                },
                            ]
                        ),
                        DOC_NODES.hiddenSeparator,
                            ...
                            children: [
                                ...
                                DOC_NODES.hiddenSeparator,
                                {
                                    cells: {
                                        kulCode: {
                                            shape: 'code',
                                            value: "const kulTheme = new KulTheme();\nkulTheme.set('dark');",
                                        },
                                    },
                                    id: DOC_IDS.content,
                                },
