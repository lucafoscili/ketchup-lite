                    ...
                    children: [
                        {
                            children: [
                                ...
                                {
                                    id: DOC_IDS.content,
                                    value: ' provides utilities to interact with language models, including sending requests for completions, polling results, and handling speech-to-text.',
                                },
                            ],
                        ...
                        },
                        {
                            children: [
                                {
                                    id: DOC_IDS.content,
                                    value: "KulLLM is designed to facilitate interactions with AI models, such as OpenAI's GPT, enabling developers to integrate natural language processing features into their applications.",
                                },
                            ],
                            id: DOC_IDS.paragraph,
                            value: '',
                    ...
                    children: [
                        ...
                        PARAGRAPH_FACTORY.asBulletListEntry('KulLLMRequest', [
                            ...
                            },
                            {
                                title: 'prompt (string)',
                                description:
                                    ': The input prompt for generating a completion.',
                            },
                            {
                        ...
                        PARAGRAPH_FACTORY.asBulletListEntry('KulLLMRole', [
                            ...
                            },
                            {
                                title: 'user',
                                description:
                                    ': Represents the end-user sending the input.',
                            },
                            {
                                title: 'assistant',
                                description:
                        ...
                        PARAGRAPH_FACTORY.asListEntry(
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    description:
                                        'The button to control speech recognition.',
                                },
                            ]
                        ),
                    ],
