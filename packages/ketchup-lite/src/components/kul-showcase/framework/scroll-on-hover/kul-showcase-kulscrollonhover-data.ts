                    ...
                    children: [
                        {
                            children: [
                                ...
                                {
                                    id: DOC_IDS.content,
                                    value: ' allows elements to scroll automatically when the user hovers near the edges. It is designed to simplify navigation through wide or long containers in the Ketchup Lite library.',
                                },
                            ],
                        ...
                        },
                        {
                            children: [
                                {
                                    id: DOC_IDS.content,
                                    value: 'This utility is useful for enhancing the user experience when working with overflow content by automatically scrolling the container based on mouse position.',
                                },
                            ],
                            id: DOC_IDS.paragraph,
                            value: '',
                            ...
                            [
                                {
                                    title: 'BOTTOM',
                                    description:
                                        ': Scrolls towards the bottom of the element.',
                                },
                                {
                                    title: 'LEFT',
                                    description:
                                        ': Scrolls towards the left of the element.',
                                },
                                {
                                    title: 'RIGHT',
                                    description:
                                        ': Scrolls towards the right of the element.',
                                },
                                {
                                    title: 'TOP',
                                    description:
                                        ': Scrolls towards the top of the element.',
                                },
                            ]
                        ),
                    ],
                            ...
                            [
                                {
                                    ...
                                    type: 'KulScrollOnHoverElement',
                                    description:
                                        'The element to check registration for.',
                                },
                            ]
                        ),
                        DOC_NODES.hiddenSeparator,
                            ...
                            [
                                {
                                    ...
                                    type: 'MouseEvent',
                                    description:
                                        'The mouse event that triggers the scroll.',
                                },
                            ]
                        ),
                        DOC_NODES.hiddenSeparator,
