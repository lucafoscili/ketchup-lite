...
const KulShowcaseUpload: StencilReactComponent<KulShowcaseUploadElement, KulShowcaseUploadEvents> = /*@__PURE__*/ createComponent<KulShowcaseUploadElement, KulShowcaseUploadEvents>({
...
export default KulShowcaseUpload;
