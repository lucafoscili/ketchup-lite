...
const KulShowcaseTabbar: StencilReactComponent<KulShowcaseTabbarElement, KulShowcaseTabbarEvents> = /*@__PURE__*/ createComponent<KulShowcaseTabbarElement, KulShowcaseTabbarEvents>({
...
export default KulShowcaseTabbar;
