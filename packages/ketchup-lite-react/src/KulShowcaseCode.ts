...
const KulShowcaseCode: StencilReactComponent<KulShowcaseCodeElement, KulShowcaseCodeEvents> = /*@__PURE__*/ createComponent<KulShowcaseCodeElement, KulShowcaseCodeEvents>({
...
export default KulShowcaseCode;
